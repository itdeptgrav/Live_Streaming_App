// The canonical exportable documentation, in Markdown.
//
// One string, several representations: /docs/grav-stream-docs.md serves it as
// Markdown, /docs/llms.txt as plain text for pasting into an assistant, and
// /docs renders the same material as a page. Keeping the source here means the
// formats cannot drift apart.
//
// Kept in sync with INTEGRATION.md at the repository root by hand — Vercel
// builds only the web directory, so the root file is not readable at runtime.
...
export const DOCS_MARKDOWN = DOC;
export const DOCS_FILENAME = "grav-stream-docs";
